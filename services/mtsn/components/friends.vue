<template>
    <div class="layout-view">
        <v-toolbar flat color="white lighten-2" dense class="">
            ...
            <v-spacer></v-spacer>
            <v-btn flat="flat" :disabled="selected.length === 0" @click.stop="remove"><v-icon color="red darken-2" class="mr-1 mb-1">fas fa-times</v-icon>remove from friends</v-btn>
        </v-toolbar>
...
-->
                    <div style="display: flex; align-items: center">
                        ...
                        <div style="flex: 1" class=""><a :href="'./feed:' + props.item.public_id" @click.prevent="$page('feed:' + props.item.public_id)">{{ props.item.name }}</a></div>
